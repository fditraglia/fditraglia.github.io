...
task :check do
  ...
  problems = []
  if File.exist?(File.join(File.dirname(__FILE__), 'research.md'))
    problems << "research.md exists. The research page is now generated by research.html from _data/papers.yml; " \
                "move any edits into the data file and delete research.md, or the two pages will conflict"
  end
  ids = Hash.new(0)
